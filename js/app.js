...
//     $('#employeeContactNumber').click(function() {
//     $cf = $('#employeeContactNumber');
//     $cf.blur(function(e){
//         phone = $(this).val();
//         phone = phone.replace(/[^0-9]/g,'');
//         if (phone.length !=10)
//         {
//             // displayErrorMsgForPhoneNo();

//             // $('#employeeContactNumber').val('');
//             // $('#employeeContactNumber').focus();
//             alert('Please enter valid contact number that consists of 10 digits');
...
function postData() {
    ...
    $.ajax({
        type: "POST",
        url: "https://id-application-form-a0436.firebaseio.com/form.json",
        data: data,
